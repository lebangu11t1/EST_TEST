                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <input class="form-control" id="starting_date" name="starting_date" placeholder="DD/MM/YYYY"
                                       type="text" required/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group ">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <input class="form-control" id="ending_date" name="ending_date" placeholder="DD/MM/YYYY"
                                       type="text" required/>
                            </div>
                        </div>
                    </div>
